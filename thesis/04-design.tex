...
\todo{speaks-for records are used to talk about links in the speaks-for chain}
...
\caption{When \sys applies topic-based anonymization to Bea's comments on
    ...
    pseudoprincipals, \todo{and diff records containing the comments with
...
\todo{integrate new update design here!}
...
(as functions from database objects to new database objects\todo{Check!}) in \sys's replay log.
%
