...
Should developers want to support disguised data without encryption (as
described in \S\ref{s:semantics:noencrypt}), then certain aspects of \sys's
design would be unnecessary. This section describes these aspects and potential
...
Instead of moving disguised data into a new database table for disguised data as \sys does, developers could also choose to implement disguised data by
