...
performs removes from tables in topologically-sorted order.
\sys then performs decorrelations and modifications in specification order,
...
\todo{should this be discussion or here? it works better here, i think...}
%
