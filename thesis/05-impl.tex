...
%because public key encrypted which \xx records
...
In the \sys prototype, updates are represented as pure functions from database
objects (represented as $<$table, column, value$>$ tuples in Rust) to new database
objects.
