...
// disguises principal p according to the spec, optionally over already-disguised data ((*\S\ref{s:composition}*))
(*\textbf{disguiseData}*)(
        p: Option<UID>, 
        spec: disguiseSpec,
        principal_gen: principalGenerator,
        schema: schemaFile,
        disguise_over: Option<Credential>) 
    -> disguiseID;

// Reveals data disguised by s for p with p's password. 
// pp_ref_policy informs Edna now to handle new references to pseudoprincipals.
(*\textbf{RevealData}*)(
    p: Option<UID>, 
    s: disguiseID, 
...
(*\textbf{CanSpeakFor}*)(p: UID, cred: Credential) -> Vec<UID>;
