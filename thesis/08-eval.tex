...
return to a service infrequently. 
Furthermore, users will likely wait for a couple seconds for account
restoration, and raAccount removal can run in the background, so
latency has no impact on the disguising user (and a couple seconds falls far
below the requirement of the GDPR of completing under 30 days).  
}
