...
principal refers to an application object representing a user (\eg an entry in a
\texttt{users} table). This thesis uses principal to mean either an 
application object representing a real application client with an account, or a
