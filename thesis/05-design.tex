...
%
\item encrypts the speaks-for and diff records with Bea's public key and stores
them; and
%
\item returns a unique \xx ID to the application.
\end{enumerate}
