...
schema migrations. However, these operations would fail to affect any data
...
these global database changes in order to preserve correctness upon reveal,
which would require the developer to remember and reapply these management
operations on disguised data before revealing it.}
%
...
\begin{enumerate}[nosep]
    ...
    \item Design techniques to realize disguised data, including diff records,
        speaks-for chains, \lyt{and the update replay log}.
        (Ch.~\ref{ch:design}).
