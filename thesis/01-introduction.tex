...
must also affect any data disguised at the time, but the developer cannot
apply them immediately to the disguised data: disguised data remains
inaccessible to the application and developer until revealed. In order to
restore disguised data correctly, the developer must apply updates to disguised
