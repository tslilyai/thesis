...
%
\subsection{Disguise Records and Reveal Credentials}
...
\emph{disguise records}, and unlocks
...
\begin{enumerate}[nosep]
    ...
    \item Design techniques to realize disguised data, including disguise records and speaks-for chains.
        (Ch.~\ref{ch:design})
