...
Once \sys has decorrelated some principal's data to a pseudoprincipal, future
disguises applied by the principal's user will fail to further disguise that
data.
%
