...
\subsection{\texttt{RegisterPrincipal}}
    ...
    credential (\S\ref{s:impl:cred}).  This allows the user to provide any of
    their private key, their password, or their backup credential to unlock and
    reveal their disguised data. 
%
