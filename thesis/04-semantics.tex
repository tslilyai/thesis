This chapter describes \todo{informal} high-level semantics that a developer can use to
...
%
\todo{First, if disguises after $D$ had decorrelated the same data as $D$, then
...
\todo{Call to list all disguises (id + desc) applied to user's data? doesn't
exist today but could add it}
...
pseudoprincipals overlap.
%
\todo{This may be too restrictive for some applications' purposes: for example, an
