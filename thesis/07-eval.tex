...
\end{tabular}
    \caption{Amount of data before and after 10\% of users remove their
    accounts. Edna adds an extra 87.5MB on disk (and 44MB in memory).}
    \label{f:storage}
\end{figure}
...
initially consumes 12 MB, which consists of entires in the principals table and
