...
The latency of disguising operations depends on load: the expensive user's
account removal and revealing take 4.7 and 10.6 seconds under high load, and 3.2
and 6.9 seconds under low load.
\lyt{Note: these numbers are about the same (if not higher) when not using
transactions.}
%
