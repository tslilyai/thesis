...
\todo{actually measure and put results}

We next look at how \sys's reveal performance changes when operating in the
presence of schema migrations or other conflicting dataabase changes.  We
evaluate the latency of reveal operations in Lobsters with a schema change that
\todo{schema change here}, and a frivolous global developer modification that
removes all vowels in text.
%
...
\todo{Add space overhead of Reveals with Database Changes}
...
\todo{Add concurrent impact of Reveals with Database Changes}
