...
\subsection{Categories of Updates}
The bulk update for URL normalization reuses the update which
performs URL-normalization as a subroutine. The bulk updates for the other two
schema migrations required writing separate updates that operate on
...
one line of code per update to register the update with \sys, after
