...
\begin{figure}[t]
    ...
    have a <7\% impact on application request throughput when disguising a
...
%
The three implemented updates do not affect other row types. However, the
implementation of Lobsters' updates does iterate through all rows to check
whether to update them, and each row iteration takes $\approx$1$\mu$. At scale
