...
\begin{figure}
    ...
    writing separate update specifications; however, updates like
...
\begin{figure}
    ...
    \caption{Out of the most recent 20 Lobsters global database updates,
...
state of other database tables. In the investigated Lobsters global database updates, two operations out of the 20 were unsupported, and both updated the
