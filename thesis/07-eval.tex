...
\todo{xxx}ms, and 
%
creating and populating the \texttt{story\_texts} table takes \todo{xxx}ms.%

\todo{reveal performance afterwards}
...
into \sys-specific Rust datatypes; this takes $\approx1$ms on average. This
