...
scenario) has a larger
effect, with throughput reduced by up to $6.4$\% (without transactions) and up
to $26$\% (with transactions).
...
revealing transformations take only milliseconds.  The expensive user's account
removal and revealing take 4.7 and 10.6 seconds under high load, and 3.2 and 6.9
seconds under low load. \lyt{Note: these numbers are about the same (if not
