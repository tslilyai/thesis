...
%
\Xxing and revealing operations are also 2--7$\times$ slower than \sys.
%
...
%
Admin-applied anonymization incurs the highest overhead (+156.4ms) as it issues
...
suffers similar overheads (+127.7ms).
%
