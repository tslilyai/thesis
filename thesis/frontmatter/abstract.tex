...
developer effort (\S\ref{s:eval-effort}) and moderate performance impact on
application operation throughput (\S\ref{s:eval-conc}).
%
...
1--7\% in the common case and up to 28\% in the worst case (when the user owning
over 1\% of all application data continuously disguises and reveals their
account).
%
