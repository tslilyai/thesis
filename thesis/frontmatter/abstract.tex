...
anonymized state.
%
With \sys, this thesis argues that web applications can enable flexible privacy
features with reasonable efforts and costs, and thus can and should be widely
supported.
%
