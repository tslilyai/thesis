More than ever before, web services today must address the question of who controls
...
%third parties in ways unwelcome or unknown to the user.  While developers
%increasingly need and want to implement better user controls in their web
%applications, doing so is challenging: the data that users want to protect is
%often important for the service's function.
%
...
%, and contributes practical systems that
